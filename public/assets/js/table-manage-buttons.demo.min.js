...
*/var handleDataTableButtons=function(){
	...
	0!==$("#data-table").length&&$("#data-table").DataTable({
		"oLanguage": 
                { "sEmptyTable": "No hay registros disponibles", "sInfo": "Hay _TOTAL_ registros. Mostrando de (_START_ a _END_)", "sLoadingRecords": "Por favor espera - Cargando...", "sSearch": "Filtro:" ,"sLengthMenu":"","stripeClasses": [ 'odd-row', 'even-row' ], "oPaginate": { "sLast": "Última página", "sFirst": "Primera", "sNext": "Siguiente", "sPrevious": "Anterior" } } 
                ,
                "order": [[0, '']],
		dom:"Bfrtip",
		buttons:[
