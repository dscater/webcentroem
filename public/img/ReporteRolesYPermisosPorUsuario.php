...
class ReporteRolesYPermisosPorUsuario extends \FPDF
{
    ...
    {          
        ...
        $this->Cell(320, 6, utf8_decode("REPORTE ROLES Y PERMISOS ASIGNADOS AL USUARIO"), 0, 1, 'C');        
    ...
    {   
        ...
        $this->Cell(50, 6, utf8_decode("Datos de Usuario:"), 0, 1, 'L');
        
        $this->SetFont('Arial', 'B', 9);
        $this->Cell(25, 6, utf8_decode("Codigó:"), 0, 0, 'L');
        $this->Cell(60, 6, utf8_decode("Usuario:"), 0, 1, 'L');
        ...
        $this->Cell(25, 6, utf8_decode($this->data->usuario->id_usuario), 0, 0, 'L');
        $this->Cell(60, 6, utf8_decode($this->data->usuario->email), 0, 1, 'L');
        

        $this->SetX(170);
        if(!empty($this->data->rda))
        {
            foreach ($this->data->rda as $key => $value) {
                
                $this->Cell(30, 6, utf8_decode($value->codigo_rda), 1, 0, 'L');
            }
        }
        $fecha_nacimiento = ($this->data->usuario->fecha_nacimiento!=null&&$this->data->usuario->fecha_nacimiento!="")?date("d-m-Y",strtotime($this->data->usuario->fecha_nacimiento)):"";
        
        $this->Ln();

        $this->SetFont('Arial', 'B', 11);
        $this->Cell(50, 6, utf8_decode("Datos de persona:"), 0, 1, 'L');
        $this->SetFont('Arial', 'B', 9);
        $this->Cell(25, 6, utf8_decode("Codigó:"), 1, 0, 'L');
        $this->Cell(45, 6, utf8_decode("N° de doc.:"), 1, 0, 'L');
        $this->Cell(50, 6, utf8_decode("Ap. paterno:"), 1, 0, 'L');
        $this->Cell(50, 6, utf8_decode("Ap. materno:"), 1, 0, 'L');
        $this->Cell(50, 6, utf8_decode("Primer nombre:"), 1, 0, 'L');
        $this->Cell(50, 6, utf8_decode("Segundo nombre:"), 1, 0, 'L');
        $this->Cell(30, 6, utf8_decode("Fecha de nac.:"), 1, 1, 'L');

        
        $this->SetFont('Arial', '', 9);

        $this->Cell(25, 6, utf8_decode($this->data->usuario->id_persona), 1, 0, 'L');
        $this->Cell(45, 6, utf8_decode($this->data->usuario->numero_documento), 1, 0, 'L');
        $this->Cell(50, 6, utf8_decode($this->data->usuario->paterno), 1, 0, 'L');        
        $this->Cell(50, 6, utf8_decode($this->data->usuario->materno), 1, 0, 'L');        
        $this->Cell(50, 6, utf8_decode($this->data->usuario->nombre1), 1, 0, 'L');        
        $this->Cell(50, 6, utf8_decode($this->data->usuario->nombre2), 1, 0, 'L');
        $this->Cell(30, 6, utf8_decode($fecha_nacimiento), 1, 1, 'L');

        $this->Ln(5);
        
        
    }
    public function cabecera3($roles)
    {     
        ...
        $this->Cell(40, 6, utf8_decode("Especial"), 1, 0, 'L');
        $this->Cell(110, 6, utf8_decode("Descripción"), 1, 1, 'L');
        ...
        if(!empty($roles))
        {
            foreach ($roles as $key => $value) {
                $this->SetWidths(array( 25,70,70,40,110,30,15,15,32,32,32));
    ...
    public function cabecera4($roles_permisos)
    {     
        
        $this->SetFont('Arial', 'B', 9);

        $this->Cell(25, 6, utf8_decode("Cod.Permiso:"), 1, 0, 'L');
    ...
    {   
        ...
        $this->SetFont('Arial', 'B', 11);
        $this->Cell(50, 6, utf8_decode("ROLES ASIGNADOS:"), 0, 1, 'L');

        $this->cabecera3($this->data->roles);

        
        $this->SetFont('Arial', 'B', 11);
        $this->Cell(50, 6, utf8_decode("PERMISOS ASIGNADOS DE ACUERDO AL ROL ASIGNADO:"), 0, 1, 'L');
        $this->cabecera4($this->data->roles_permisos);
