...
class SavePlanillaCase1 extends SavePlanillaFactory
{
    ...
    public function procesar(){
        ...
        $this->calcularPagoHoraExtra($this->parametros_contrato->haber_basico, $this->parametros_contrato->horas_extra);
    ...
    public function setPlanilla(){
        ...
        $planilla->laboral_porcentaje_antiguedad = $this->porcentajeBonoAntiguedad;
        $planilla->laboral_horas_extra = $this->horasExtra;
        $planilla->laboral_monto_horas_extra = $this->pagoPorHorasExtraTrabajadas;
    ...
    private function updateSaldoFavor(){
        ...
        \DB::select("UPDATE impuestos 
            set saldo_favor_mes_siguiente={$this->saldoMesSiguiente}
            where id_persona = {$this->contrato->id_persona}
