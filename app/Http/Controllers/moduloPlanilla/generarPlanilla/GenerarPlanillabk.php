...
abstract class GenerarPlanilla
{
    ...
    protected function calcularTotalGanado() {
        $this->totalGanado = $this->haberBasico + $this->bonoAntiguedad;
    ...
    protected function calcularPlanillaTributaria() {
        ...
        $this->saldoMesAnterior = $this->parametros_contrato->saldo_favor_impuestos;
        
        $this->formulario110 = $this->redondear($this->parametros_contrato->monto_impuestos, 4);
