...
class ReporteUsuarios extends \FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(300, 5, "LISTA DE USUARIOS", 0, 1, "C");
        ...
        $this->Cell(30, 5, "USUARIO", 1, 0, "C", 1);
        $this->Cell(45, 5, "NOMBRE COMPLETO", 1, 0, "C", 1);
        $this->Cell(25, 5, "C.I.", 1, 0, "C", 1);
        $this->Cell(50, 5, "EMAIL", 1, 0, "C", 1);
        $this->Cell(35, 5, utf8_decode("DIRECCIÓN"), 1, 0, "C", 1);
        $this->Cell(33, 5, "TIPO USUARIO", 1, 0, "C", 1);
        $this->Cell(25, 5, utf8_decode("TELÉFONO"), 1, 0, "C", 1);
        $this->Cell(25, 5, "CELULAR", 1, 0, "C", 1);
        $this->Cell(25, 5, "FEC. REG.", 1, 1, "C", 1);
    ...
    {        
        ...
        foreach ($resultado as $key => $value) {
            ...
            $this->SetWidths(array(10,30,45,25,50,35,33,25,25,25,25,25,25));
            ...
            $fila = array(
                ...
                utf8_decode($value->role),
                utf8_decode($value->telefono),
                utf8_decode($value->celular),
                utf8_decode(date("d-m-Y", strtotime($value->created_at))),
            );
            $this->Ln(1);
            $this->Row($fila, 3, 3, 0);
            $this->Ln(1);
