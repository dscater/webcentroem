...
class ReporteCantidadPaciente extends \FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(200, 5, "REPORTE CANTIDAD DE PACIENTES", 0, 1, "C");
        $this->Cell(200, 5, "POR ESPECIALIDAD", 0, 1, "C");
        ...
        $this->Cell(160, 5, "Especialidad", 1, 0, "C", 1);
        $this->Cell(30, 5, "Cantidad", 1, 1, "C", 1);
    ...
    {        
        ...
        if(!empty($resultado)) {
            foreach ($resultado as $key => $value) {
                ...
                $this->SetWidths(array(10,160,30));
                $this->SetAligns(array('R','L','R'));
                $fila = array(
                    utf8_decode($key+1),    
                    utf8_decode($value->especialidad),
                    utf8_decode($value->pacientes),                    
                );
                $this->Ln(1);
                $this->Row($fila, 3, 3, 0);
                $this->Ln(1);
