...
class ReporteSeguimientoControl extends \FPDF {
    ...
    public function Header() {
        ...
        $this->SetFont("Arial", "B", 9);
        $this->Cell(206, 4, utf8_decode($this->configuracion->razon_social), 0, 1, 'R');

        $this->SetFont("Arial", "B", 15);
        $this->Cell(206, 5, utf8_decode("SEGUIMIENTO Y CONTROL"), 0, 1, "C");
        ...
        $this->Cell(56, 8, "TRATAMIENTO", 1, 0, "C", 1);
        $this->Cell(56, 8, utf8_decode("DESCRIPCIÓN DE LA EVOLUCIÓN"), 1, 0, "C", 1);
        $x = $this->GetX() + 56;
        $this->Cell(56, 8, utf8_decode("MEDICAMENTOS SUMINISTRADOS"), 1, 0, "C", 1);
    ...
    public function Footer() {
        ...
        $this->Cell(106,3, utf8_decode('Página ') . trim($this->PageNo() . ' de {nb}'), 0, 1, 'R');
    ...
    {        
        ...
        if(!empty($resultado)) {
            ...
            foreach ($resultado as $key => $value) {
                ...
                $fila = array(
                    utf8_decode($key+1),    
                    utf8_decode($value->tratamiento),
                    utf8_decode($value->descripcion_evolucion),
