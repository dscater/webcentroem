...
class ReporteCitaMedica extends \FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(200, 5, utf8_decode("REPORTE CITA MÉDICA"), 0, 1, "C");
        ...
        $this->Cell(20, 5, "Fecha", 1, 0, "L", 1);
        $this->Cell(15, 5, "Hora", 1, 0, "L", 1);
        $this->Cell(30, 5, "Estado", 1, 0, "L", 1);
        $this->Cell(20, 5, "C.I.", 1, 0, "C", 1);
        $this->Cell(80, 5, "Nombre completo", 1, 0, "C", 1);
        $this->Cell(20, 5, utf8_decode("Teléfono"), 1, 1, "C", 1);
    ...
    {        
        ...
        if(!empty($resultado)) {
            foreach ($resultado as $key => $value) {
                ...
                $this->SetWidths(array(17,20,15,30,20,80,20));
                $this->SetAligns(array('L','R','R','C','L', "L", "R"));
                $fila = array(
                    utf8_decode($value->id),
                    utf8_decode($value->fecha_cita),
