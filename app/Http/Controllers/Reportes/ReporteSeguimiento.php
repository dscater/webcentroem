...
class ReporteSeguimiento extends \FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(200, 5, utf8_decode("SEGUIMIENTO Y CONTROL NRO. ".$this->resultado->nro_seguimiento), 0, 1, "C");
    ...
    public function cabecera() {
        ...
        $this->SetFont("Arial", "", 9);
        $this->Cell(45, 5, utf8_decode("Fecha y  Hora:"), 0, 0, "L");
        $this->SetFont("Arial", "", 9);
    ...
    public function historial() {
        ...
        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("1.- TRATAMIENTO"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->tratamiento), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("2.- DESCRIPCIÓN DE EVOLUCIÓN"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->descripcion_evolucion), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("3.- MEDICAMENTOS SUMINISTRADOS"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->medicamento), 0, "J");
