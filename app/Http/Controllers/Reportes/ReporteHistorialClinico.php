...
class ReporteHistorialClinico extends \FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(200, 5, utf8_decode("HISTORIA CLÍNICA NRO. ".$this->resultado->nro_historial), 0, 1, "C");
        $this->SetFont("Arial", "B", 11);
        $this->Cell(200, 5, utf8_decode($this->resultado->especialidad), 0, 1, "C");
    ...
    public function cabecera() {
        ...
        $y = $this->GetY();
        if(!empty($this->resultado->foto)){
            $this->Image('../public/fotoPersona/'.$this->resultado->foto, 128+40, $y, 40, 42);
        }
        else{
            $this->Image('../public/img/user-avatar.png', 128+40, $y, 40, 42);
        }
        
        $this->SetFillColor(196,208,218);
        $this->SetFont("Arial", "B", 9);
        $this->Cell(50, 5, utf8_decode($this->resultado->paterno), 0, 0, "C", 1);
        $this->Cell(50, 5, utf8_decode($this->resultado->materno), 0, 0, "C", 1);
        $this->Cell(50, 5, utf8_decode($this->resultado->nombre), 0, 1, "C", 1);

        $this->SetFont("Arial", "", 9);
        $this->Cell(50, 5, "Apellido Paterno", 0, 0, "C");
        $this->Cell(50, 5, "Apellido Materno", 0, 0, "C");
        $this->Cell(50, 5, "Nombres", 0, 1, "C");


        $this->Ln(2);

        $this->SetFont("Arial", "", 9);
        $this->Cell(35, 5, "Lugar de nacimiento:", 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(123, 5, utf8_decode($this->resultado->lugar_nacimiento), 0, 1, "L", 1);
        ...
        $this->SetFont("Arial", "", 9);
        $this->Cell(15, 5, utf8_decode($this->resultado->edad), 0, 0, "C", 1);

        $this->SetFont("Arial", "", 9);
        $this->Cell(20, 5, "Estado civil:", 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(30, 5, utf8_decode($this->resultado->estado_civil), 0, 0, "C", 1);

        $this->SetFont("Arial", "", 9);
        $this->Cell(20, 5, "Domicilio:", 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(61, 5, utf8_decode($this->resultado->domicilio), 0, 1, "L", 1);

        $this->Ln(2);

        $this->SetFont("Arial", "", 9);
        $this->Cell(35, 5, "Familiar responsable:", 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(108+15, 5, utf8_decode($this->resultado->familiar_responsable), 0, 1, "L", 1);

        $this->Ln(2);

        $this->SetFont("Arial", "", 9);
        $this->Cell(25, 5, utf8_decode("Teléfono:"), 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(30, 5, utf8_decode($this->resultado->telefono), 0, 0, "C", 1);

        $this->SetFont("Arial", "", 9);
        $this->Cell(20, 5, "Email:", 0, 0, "R");
        $this->SetFont("Arial", "", 9);
        $this->Cell(83, 5, utf8_decode($this->resultado->email), 0, 1, "C", 1);

        $this->Ln(2);

        $this->SetFont("Arial", "", 9);
        $this->Cell(45, 5, utf8_decode("Fecha apertura historia clínica:"), 0, 0, "L");
        $this->SetFont("Arial", "", 9);
        $this->Cell(30, 5, utf8_decode(date("d/m/Y H:i", strtotime($this->resultado->fecha_hora))), 0, 0, "C", 1);

        $this->SetFont("Arial", "", 9);
        $this->Cell(20, 5, "Doctor(ar):", 0, 0, "R");
        $this->SetFont("Arial", "", 9);
        $this->Cell(63, 5, utf8_decode($this->resultado->doctor), 0, 1, "C", 1);

        $this->Ln(2);

        $this->Line(8, $this->GetY(), 208, $this->GetY());
    ...
    public function historial() {
        ...
        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("1.- MOTIVO DE LA CONSULTA"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->motivo_consulta), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("2.- DOLENCIA ACTUAL"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->dolencia_actual), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("3.- ANTECEDENTES PATOLÓGICOS FAMILIARES"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->antecedente_familiar), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("4.- ANTECEDENTES PATOLÓGICOS PERSONALES"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->antecedente_personal), 0, "J");

        $this->Ln(2);

        $this->SetFont("Arial", "B", 9);
        $this->Cell(200, 5, utf8_decode("5.- DIAGNÓSTICO"), 0, 1, "L");
        
        $this->SetFont("Arial", "", 9);
        $this->MultiCell(200, 5, utf8_decode($this->resultado->diagnostico), 0, "J");
