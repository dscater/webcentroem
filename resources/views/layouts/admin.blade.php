				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs text-white">{{$nombre}}</span> <b class="caret  text-white"></b>
						</a>
						<ul class="dropdown-menu animated fadeInLeft">
							<li class="arrow"></li>
							<li class="text-center"><a href="{{url('perfil-usuario')}}"><span class="fa fa-cog fa-spin"></span> Ajustes de usuario</a></li>
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li id="menu-inicio"><a href="{{url('home')}}"><i class="fa fa-university"></i> Inicio</a></li>
					@if(auth()->user()->hasRole('administrador'))
					<li id="menu-configuracion"><a href="{{url('configuracion')}}"><i class="fa fa-cog fa-spin"></i> Configuración</a></li>
					@endif
					...
					<li id="menu-especialidad"><a href="{{url('/table/especialidad')}}"><i class="fa fa-book"></i> Especialidades</a></li>
					@endif
					...
					<li id="menu-administracion-usuario" class="has-sub">
						...
						<ul class="sub-menu">
							<li id="menu-usuario-form-buscar"><a href="{{url('/usuario-form-buscar')}}">Usuarios</a></li>
							<li id="menu-usuario-nuevo"><a href="{{url('/usuario-nuevo')}}">Nuevo Usuario</a></li>
						</ul>
					</li>
					@endif
					...
					<li id="menu-administracion-asignacion" class="has-sub">
						...
						<ul class="sub-menu">
							<li id="menu-asignacion-especialidad-form-buscar"><a href="{{url('/asignacion-especialidad-form-buscar')}}">Lista Asignación de especialidad</a></li>
							<li id="menu-asignacion-especialidad-nuevo"><a href="{{url('/asignacion-especialidad-nuevo')}}">Nueva Asignación de especialidad</a></li>
						</ul>
					</li>
					@endif
					...
					<li id="menu-administracion-paciente" class="has-sub">
						...
						<ul class="sub-menu">
							<li id="menu-paciente-form-buscar"><a href="{{url('/paciente-form-buscar')}}">Pacientes</a></li>
							<li id="menu-paciente-nuevo"><a href="{{url('/paciente-nuevo')}}">Nuevo Paciente</a></li>
						</ul>
					</li>
					@endif
					...
					<li id="menu-administracion-factura" class="has-sub">
						...
						<ul class="sub-menu">
							<li id="menu-factura-form-buscar"><a href="{{url('/factura-form-buscar')}}">Pagos</a></li>
					...
					<li id="menu-administracion-seguimiento" class="has-sub">
						<a href="javascript:;">
							<b class="caret pull-right"></b>
							<i class="fa fa-laptop"></i>
						...
						<ul class="sub-menu">
							<li id="menu-seguimiento-form-buscar"><a href="{{url('/seguimiento-form-buscar')}}">Lista Seguimiento</a></li>
							<li id="menu-seguimiento-nuevo"><a href="{{url('/seguimiento-nuevo')}}">Nuevo Seguimiento</a></li>
						</ul>
					</li>
					@endif --}}
					...
					<li id="menu-reporte" class="has-sub">
						...
						<ul class="sub-menu">
							@if(auth()->user()->hasRole('administrador'))
							<li id="menu-reporte-usuarios"><a href="{{url('/vista-reporte-usuarios')}}">Usuarios</a></li>
							@endif
							{{-- <li id="menu-reporte-historial-clinico"><a href="{{url('/vista-reporte-historial-clinico')}}">Historial Clínico</a></li> --}}
							{{-- <li id="menu-reporte-seguimiento-control"><a href="{{url('/vista-reporte-seguimiento-control')}}">Seguimiento y Control</a></li> --}}
							<li id="menu-reporte-paciente"><a href="{{url('/vista-reporte-paciente')}}">Pacientes</a></li>
							<li id="menu-reporte-cantidad-paciente"><a href="{{url('/vista-reporte-cantidad-paciente')}}">Cantidad de Pacientes Por Especialidad</a></li>
							<li id="menu-reporte-cita-medica"><a href="{{url('/vista-reporte-cita-medica')}}">Cita Médica</a></li>
							<li id="menu-reporte-factura"><a href="{{url('/vista-reporte-factura')}}">Pagos</a></li>
						</ul>
					</li>
					@endif

					@if(auth()->user()->hasRole('paciente'))
					<li id=""><a href="{{url('paciente-datos-registro')}}" target="blank">Datos de Registro</a></li>
					<li id=""><a href="{{url('/reporte-historial-clinico')}}" target="blank">Historial Clínico</a></li>
					<li id=""><a href="{{url('/reporte-seguimiento-control')}}" target="blank">Seguimiento y Control</a></li>
					@endif
