            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="min-height:1000px">
                    <form action="{{url('paciente-modificar-registrar/'.$user->id)}}" method="post" accept-charset="utf-8"
                        ...
                        {{csrf_field()}}
                        <h2 class="col-md-8 col-md-offset-2" id="titulo">Ver datos del Paciente</h2>
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2 form-group" style="">
                                <!--input type="submit" value="Guardar" name="guardar" class="btn btn-success"-->
                                <a href="{{url('paciente-form-buscar')}}" class="btn btn-success">Vovel al listado</a>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div  class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-nombre">
                                            <input name="nombre" value="{{(!empty(old('nombre'))) ? old('nombre') : $persona->nombre}}" class="app-form-control form-control  fadeInLeft animated" id="input-nombre" type="text" required disabled>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-paterno">
                                            <input name="paterno" value="{{(!empty(old('paterno'))) ? old('paterno') : $persona->paterno}}" class="app-form-control form-control  fadeInLeft animated" id="input-paterno" type="text" disabled>
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-materno">
                                            <input name="materno" value="{{(!empty(old('materno'))) ? old('materno') : $persona->materno}}" class="app-form-control form-control  fadeInLeft animated" id="input-materno" type="text"  disabled>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="div-create-telefono">
                                            <input name="telefono" value="{{(!empty(old('telefono'))) ? old('telefono') : $persona->telefono}}" class="app-form-control form-control  fadeInLeft animated" id="input-telefono" type="number" requiredd  disabled>    
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="email" value="{{(!empty(old('email'))) ? old('email') : $persona->email}}" class="app-form-control form-control  fadeInLeft animated" id="input-email" type="text" requiredd  disabled="">
                                        @if ($errors->has('email'))
                                     ...
                                     <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-domicilio">
                                            <input name="domicilio" value="{{(!empty(old('domicilio'))) ? old('domicilio') : $persona->domicilio}}" class="app-form-control form-control  fadeInLeft animated" id="input-domicilio" type="text" required disabled>
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-familiar_responsable">
                                            <input name="familiar_responsable" value="{{(!empty(old('familiar_responsable'))) ? old('familiar_responsable') : $persona->familiar_responsable}}" class="app-form-control form-control  fadeInLeft animated" id="input-familiar_responsable" type="text" requiredd  disabled>
                                        </div>
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        ...
                                        <div class="div-create-password">
                                            <input name="password" value="" class="app-form-control form-control  fadeInLeft animated" id="input-direccion" type="text" requiredd  disabled>
                                        </div>
                                    </div>
                                ...
                                <div  class="col-md-12">
                                    <div  class="col-md-8">
                                        ...
                                        <div class="form-group col-md-12" style="padding:0">
                                            ...
                                            <input name="ci" value="{{(!empty(old('ci'))) ? old('ci') : $persona->ci}}" class="app-form-control form-control  fadeInLeft animated" id="input-ci" type="text" required disabled>
                                            @if ($errors->has('ci'))
                                        ...
                                        <div  class="col-12">
                                            <div class="form-group col-md-12"  style="padding:0">
                                                ...
                                                <div class="div-create-id_role">
                                                    <select name="estado_civil" id="" class="form-control chosen-select" data-rel="chosen" placeholder="Seleccionar" requiredd  disabled>
                                        ...
                                        <div class="form-group col-md-12" style="padding:0">
                                            ...
                                            <input name="edad" value="{{(!empty(old('edad'))) ? old('edad') : $persona->edad}}" class="app-form-control form-control  fadeInLeft animated" id="input-edad" type="text" required disabled>
                                            @if ($errors->has('edad'))
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="genero" value="HOMBRE" <?= ($genero=="HOMBRE")?"checked":""?>  disabled>
                                                HOMBRE
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="genero" value="MUJER" <?= ($genero=="MUJER")?"checked":""?>  disabled>
                                                MUJER
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="genero" value="OTRO" <?= ($genero=="OTRO")?"checked":""?>  disabled>
                                                OTRO
                                            </label>
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        ...
                                        <div class="col-md-4" style="padding:0">
                                            ...
                                            <select name="dia_nac" id="dia" class="app-form-control form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="Día" requiredd  disabled>
                                                <option value=""></option>
                                                @for($i=1; $i<=31;$i++)
                                        ...
                                        <div class="col-md-4"  style="padding:0">
                                            ...
                                            <select name="mes_nac" id="mes" class="app-form-control form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="mes" requiredd  disabled>
                                                <option value=""></option>
                                        ...
                                        <?php $anio_nac = (!empty(old('anio_nac'))) ? old('anio_nac') : date("Y", strtotime($persona->fecha_nacimiento))?>
                                            <select name="anio_nac" id="anio" class="app-form-control form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="Año" requiredd  disabled>
                                                <option value=""></option>
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        ...
                                        <div class="div-create-lugar_nacimiento">
                                            <input name="lugar_nacimiento" value="{{(!empty(old('lugar_nacimiento'))) ? old('lugar_nacimiento') : $persona->lugar_nacimiento}}" class="app-form-control form-control  fadeInLeft animated" id="input-lugar_nacimiento" type="text" requiredd  disabled>
                                        </div>
                                    ...
                                    <div  class="col-12">
                                        <div class="app-form-group form-group col-md-12">
                                            ...
                                            <div class="div-create-id_especialidad">
                                                <select name="id_especialidad" id="id_especialidad" class="form-control chosen-select" data-rel="chosen" placeholder="Seleccionar" requiredd  disabled>
                                                    <option value="">Seleccionar</option>
