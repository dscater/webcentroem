            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="min-height:1000px">
                    <form action="{{url('historial-clinico-modificar-registrar/'.$historial_clinico->id)}}" method="post" accept-charset="utf-8"
                        ...
                        {{csrf_field()}}
                        <h2 class="col-md-8 col-md-offset-2" id="titulo">Modificar datos del Historial Clínico</h2>
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2 form-group" style="">
                                ...
                                <a href="{{url('historial-clinico-reporte/'.$historial_clinico->id)}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> PDF</a>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div  class="col-12">
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="motivo_consulta" class="form-control " id="input-motivo_consulta">{{$motivo_consulta}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="dolencia_actual" class="form-control " id="input-dolencia_actual">{{$dolencia_actual}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="antecedente_familiar" class="form-control " id="input-antecedente_familiar">{{$antecedente_familiar}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="antecedente_personal" class="form-control " id="input-antecedente_personal">{{$antecedente_personal}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="diagnostico" class="form-control " id="input-diagnostico"><?php echo $diagnostico?></textarea>
