                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        @if ($factura->tipo_paciente == 'PACIENTE PARTICULAR')
                                            <div class="form-group col-md-4">
                                                <label class="app-label nro_factura"><span>*</span> Nro. de la
                                                    factura:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @foreach ($factura->factura_conceptos as $fc)
                                                        <div class="div-create-concepto" style="margin-bottom: 5px;">
                                                            <input name="concepto" value="{{ $fc->concepto }}"
                                                                class="app-form-control form-control  fadeInLeft animated"
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <!-- begin col-2 -->
                                                <div class="form-group col-md-6">
                                                    <label class="app-label monto_total"><span>*</span> Monto
                                                        Total:</label>
