                                    ...
                                    <tr class="" id="tabla-tr-1">
                                        ...
                                        <td>
                                            <ul style="padding-left: 5px;">
                                                @foreach ($value->factura_conceptos as $fc)
                                                    <li>{{ $fc->concepto }}</li>
                                                @endforeach
                                            </ul>
                                        </td>
                                        ...
                                        <td class="td-acciones">
                                            <a class="btn btn-xs btn-inverse" href="{{ url('factura-ver/' . $value->id) }}"
                                                target="blank"><span class="fa fa-eye"></span> Ver</a>
