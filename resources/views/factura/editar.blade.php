                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="div-create-tipo_paciente">
                                        <select name="tipo_paciente" id="tipo_paciente" class="form-control">
                                            ...
                                            <option value="PACIENTE PARTICULAR" {{$factura->tipo_paciente == 'PACIENTE PARTICULAR'? 'selected':''}}>PACIENTE PARTICULAR</option>
                                            <option value="PACIENTE ASEGURADO" {{$factura->tipo_paciente == 'PACIENTE ASEGURADO'? 'selected':''}}>PACIENTE ASEGURADO</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div  class="col-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="div-create-fecha_factura">
                                        <input name="fecha_factura" value="{{(!empty(old('fecha_factura'))) ? old('fecha_factura') : $factura->fecha_factura}}" class="app-form-control form-control  fadeInLeft animated" id="input-fecha_factura" type="date" required>
                                ...
                                <!-- begin col-2 -->
                                <div class="form-group col-md-4">
                                    <label class="app-label nro_factura"><span>*</span>  Nro. de la factura: {{$factura->nro_factura}}</label>
                                </div>
                                <!-- begin col-2 -->
                                <div class="form-group col-md-4">
                                    <label class="app-label paciente_ci"><span>*</span>  CI/NIT:</label>
                                    <div class="div-create-paciente_ci">
                                        <input name="paciente_ci" value="{{(!empty(old('paciente_ci'))) ? old('paciente_ci') : $factura->paciente_ci}}" class="app-form-control form-control  fadeInLeft animated" id="input-paciente_ci" type="number" required>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="div-create-paciente_nombre">
                                        <input name="paciente_nombre" value="{{(!empty(old('paciente_nombre'))) ? old('paciente_nombre') : $factura->paciente_nombre}}" class="app-form-control form-control  fadeInLeft animated" id="input-paciente_nombre" type="text" required>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="div-create-monto">
                                        <input name="monto" value="{{(!empty(old('monto'))) ? old('monto') : $factura->monto}}" class="app-form-control form-control  fadeInLeft animated" id="input-monto" type="text" required>
                                        @if ($errors->has('monto'))
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="div-create-concepto">
                                        <input name="concepto" value="{{(!empty(old('concepto'))) ? old('concepto') : $factura->concepto}}" class="app-form-control form-control  fadeInLeft animated" id="input-concepto" type="text" required>
