                ...
                if(!empty($columnas))
                {
                    foreach ($columnas as $key => $values) {
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <label class="col-md-3 text-right {{$columnas[$key]->COLUMN_NAME}}" ><span>{{$required_label}}</span>  {{$columna}}:</label>
                            <div class="col-md-3">
                                <select name="{{$columnas[$key]->COLUMN_NAME}}"id="select-{{$columnas[$key]->COLUMN_NAME}}" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="{{$columna}}">
                                    <option value=""></option>
                                    <?php 
                                    if(!empty($enum)){
