...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="" method="" accept-charset="utf-8" id="formulario">
                

                <h2 class="col-md-3 col-md-offset-2" id="titulo">{{str_replace("_"," ",strtoupper ($nombre_tabla))}}</h2>
                <div class="row">
                ...
                if(!empty($columnas))
                {
                    foreach ($columnas as $key => $values) {
                        $value="";
                        $nombre_campo=$columnas[$key]->COLUMN_NAME;
                        ...
                        <?php 
                        if($columnas[$key]->DATA_TYPE!="enum"&&strpos($columnas[$key]->COLUMN_NAME,"id_")===false&&strpos($columnas[$key]->COLUMN_NAME,"_imagen")===false&&$columnas[$key]->COLUMN_NAME!="created_at"&&$columnas[$key]->COLUMN_NAME!="updated_at"&&$columnas[$key]->COLUMN_NAME!="id"&&$columnas[$key]->COLUMN_NAME!="state"){?>
                        <!-- begin col-2 -->                                
                        <div class="form-group col-md-12">
                            
                            <label class="col-md-3 text-right {{$columnas[$key]->COLUMN_NAME}}" ><span>{{$required_label}}</span>  {{$columna}}:</label>
                            <div class="col-md-3">
                                <input name="{{$columnas[$key]->COLUMN_NAME}}" class="form-control " id="input-{{$columnas[$key]->COLUMN_NAME}}"   type="{{$type}}" {{$required}} value="{{$registro->$nombre_campo}}" disabled>    
                            </div>
                        ...
                        else if($columnas[$key]->COLUMN_NAME=="state"){
                            if($registro->$nombre_campo==1){
                                $valor = "ACTIVO";
                            }
                            else{
                            $valor = "ELIMINADO";
                        ...
                        ?>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <label class="col-md-3 text-right {{$columnas[$key]->COLUMN_NAME}}" ><span>{{$required_label}}</span>  Estado:</label>
                                <div class="col-md-3">
                                    <input name="{{$columnas[$key]->COLUMN_NAME}}" class="form-control " id="input-{{$columnas[$key]->COLUMN_NAME}}"   type="{{$type}}" {{$required}} value="{{$valor}}" disabled>    
                                </div>
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <label class="col-md-3 text-right {{$columnas[$key]->COLUMN_NAME}}" ><span>{{$required_label}}</span>  {{$columna}}:</label>
                            <div class="col-md-3">
                                <select name="{{$columnas[$key]->COLUMN_NAME}}"id="select-{{$columnas[$key]->COLUMN_NAME}}" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" disabled>
                                    <?php 
                                    if(!empty($enum)){
                                        foreach ($enum as $key1 => $value1) {
                                    ?>
                                    <option value="{{$value1}}" <?php echo ($registro->$nombre_campo==$value1)?'selected':'';?>>{{$value1}}</option>
                        ...
                        else if(strpos($columnas[$key]->COLUMN_NAME,"id_")!==false)
                        {
                            ...
                            if($columnas[$key]->COLUMN_COMMENT!=""){
                                $nombre_tabla_1=$columnas[$key]->COLUMN_COMMENT;
                            }
                            else{
                            ...
                            $registros_1=TableModel::registros_by_tabla($nombre_tabla_1,"and state=1");
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <label class="col-md-3 text-right {{$columnas[$key]->COLUMN_NAME}}" ><span>{{$required_label}}</span> {{ucwords($nombre_tabla_1)}}:</label>
                            <div class="col-md-3">
                                <select name="{{$columnas[$key]->COLUMN_NAME}}"id="select-{{$columnas[$key]->COLUMN_NAME}}" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="{{$nombre_tabla_1}}" disabled>
                                    <option value=""></option>
                                    <?php 
                                    if(!empty($registros_1)){
                                        ...
                                        {
                                    ?>
                                    <option value="{{$value1->id}}" <?php echo ($registro->$nombre_campo==$value1->id)?'selected':'';?>>
                                    <?php 
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <div class="col-md-3">
                                ...
                                if($registro->$nombre_campo=="")
                                {
                                    ...
                                    $imagen=url('')."/img/".$registro->$nombre_campo;    
                                }
                                ?>
...
<script>
    ...
    $("#menu-parametros").addClass("active");
    $("#menu-{{$nombre_tabla}}").addClass("active");
</script>
