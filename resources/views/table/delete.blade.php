...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/table/{{$nombre_tabla}}/{{$id}}" method="post" accept-charset="utf-8" id="formulario">
                {{csrf_field()}}
                        ...
                        <?php 
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-3 div-edit-{{$columnas[$key]->COLUMN_NAME}}">
                                    <select name="{{$columnas[$key]->COLUMN_NAME}}"id="select-{{$columnas[$key]->COLUMN_NAME}}" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" {{$required}} disabled>
