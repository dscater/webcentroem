                            ...
                            <tr class="" id="tabla-tr-<?php echo $value->id;?>">
                                ...
                                foreach ($columnas as $key1 => $value1) {
                                    ...
                                    if(strpos($columnas[$key1]->COLUMN_NAME,"id_")!==false)
                                    {
                                      ...
                                      if($columnas[$key1]->COLUMN_COMMENT!=""){
                                        $nombre_tabla_1=$columnas[$key1]->COLUMN_COMMENT;
                                      }
                                      else{
                                      ...
                                      else if(!empty($registros_1))
                                      {
                                        $valor=$registros_1[0]->$nombre_tabla_1;
                                      }
                                    }
                                    else if(strpos($columnas[$key1]->COLUMN_NAME,"_imagen")!==false)
                                    {
                                    ...
                                    else if($columnas[$key1]->COLUMN_NAME=="state"){
                                      if($value->$nombre_campo==1){
                                        $valor = "ACTIVO";
                                      }
                                      else{
                                        $valor = "ELIMINADO";
                                ...
                                <?php }?>
                                <td class="td-acciones">
                                  <a class="btn btn-xs btn-inverse" href="{{url('')}}/table/{{$nombre_tabla}}/{{$value->id}}" ><span class="fa fa-eye"></span> Ver</a>
                                  <a class="btn btn-xs btn-info" href="{{url('')}}/table/{{$nombre_tabla}}/{{$value->id}}/edit" title="" ><span class="fa fa-pencil-square-o"></span> Editar</a>
                                  <a class="btn btn-xs btn-danger" href="{{url('')}}/table/{{$nombre_tabla}}/{{$value->id}}/delete" title="" ><span class="fa fa-trash"></span> Eliminar</a>
                                </td>
