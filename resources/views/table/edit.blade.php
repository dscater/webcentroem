...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/table/{{$nombre_tabla}}/{{$id}}" method="post" accept-charset="utf-8" id="formulario" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    foreach ($columnas as $key => $values) {
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-3 div-edit-{{$columnas[$key]->COLUMN_NAME}}">
                                <input name="{{$columnas[$key]->COLUMN_NAME}}" class="form-control " id="input-{{$columnas[$key]->COLUMN_NAME}}"   type="{{$type}}" {{$required}} value="{{$registro->$nombre_campo}}">    
                            </div>
