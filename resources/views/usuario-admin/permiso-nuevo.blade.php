        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{url('permisos-nuevo-registrar')}}" method="post" accept-charset="utf-8" id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" style="">
                                <h2>Formulario de Registro de Permiso</h2>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div  class="col-md-12 app-card style-card">
                                    ...
                                    <div class="app-form-group form-group col-md-6">
                                        <label class="app-label name"><span>*</span>  Nombre de Permiso:</label>
