                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group" style="">
                            <h2></h2>
                            <a class="btn btn-success" href="{{url('permisos-nuevo')}}" target="blank">
                                <span class="fa fa-plus"></span> Nuevo Permiso
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th colspan="8" class="text-center"><h3>Permisos</h3></th>
                                        </tr>
                                        <tr>
                                            <th>Codigo del Permiso</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs m-r-5" href="{{url('permisos-modificar/'.$value->id)}}" target="blank">
