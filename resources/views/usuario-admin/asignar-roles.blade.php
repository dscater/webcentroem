                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-9" style="">
                            <h2>Formulario Asignación de Roles</h2>
                        </div>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$value->name}}</td>
                                            <td>
                                                <form action="{{url('usuario-asignar-roles-registrar/'.$usuario->id)}}" method="post" id="form-{{$value->id}}">
                                                    {{csrf_field()}}
                                                    <?php $classSi=($value->asignado=="si")?'success':'default'?>
                                                    <?php $classNo=($value->asignado=="no")?'danger':'default'?>
                                                    <?php $typeSi=($value->asignado=="si")?'button':'submit'?>
                                                    <?php $typeNo=($value->asignado=="no")?'button':'submit'?>
                                                    <input type="hidden" name="role_id" value="{{$value->id}}">
                                                    <input type="hidden" name="id_role_user" value="{{$value->id_role_user}}">
                                                    <input class="btn btn-{{$classSi}} btn-xs m-r-5" name="asignar" type="{{$typeSi}}" value="Si">
                                                    <input class="btn btn-{{$classNo}} btn-xs m-r-5" name="asignar" type="{{$typeNo}}" value="No">
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
