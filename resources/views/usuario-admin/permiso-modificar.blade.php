        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{url('permisos-modificar-registrar/'.$permiso->id)}}" method="post" accept-charset="utf-8" id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" style="">
                                <h2>Formulario Editar datos de Permiso</h2>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div  class="col-md-12 app-card style-card">
                                    ...
                                    <div class="app-form-group form-group col-md-6">
                                        <?php $name=(!empty(old('name')))?old('name'):((!empty($permiso->name))?$permiso->name:'') ?>
                                    ...
                                    <!-- begin col-2 -->
                                    <div class="app-form-group form-group col-md-6">
                                        <?php $slug=(!empty(old('slug')))?old('slug'):((!empty($permiso->slug))?$permiso->slug:'') ?>
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        <?php $description=(!empty(old('description')))?old('description'):((!empty($permiso->description))?$permiso->description:'') ?>
