        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{url('usuario-modificar-registrar/'.$usuario->id)}}" method="post" accept-charset="utf-8" id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                            ...
                            <div class="col-md-12">
                                <div  class="col-md-12 app-card style-card">
                                    ...
                                    <div class="app-form-group form-group col-md-6">
                                        ...
                                        <div class="div-create-email">
                                            <input name="email" value="{{$email}}" class="app-form-control form-control  fadeInLeft animated" id="input-email" type="text" requiredd="">
                                        </div>
                                        @if ($errors->has('email'))
                                    ...
                                    <!-- begin col-2 -->
                                    <div class="app-form-group form-group col-md-6">
                                        <?php $password=(!empty(old('password')))?old('password'):''?>
                                        <label class="app-label password"><span>*</span>  Clave:</label>
                                        <div class="div-create-password">
                                            <input name="password" value="{{$password}}" class="app-form-control form-control  fadeInLeft animated" id="input-password" type="text" requiredd="">
                                        </div>
