        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{url('roles-modificar-registrar/'.$role->id)}}" method="post" accept-charset="utf-8" id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" style="">
                                <h2>Formulario Editar datos de Rol</h2>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div  class="col-md-12 app-card style-card">
                                    ...
                                    <div class="app-form-group form-group col-md-6">
                                        <?php $name=(!empty(old('name')))?old('name'):((!empty($role->name))?$role->name:'') ?>
                                        <label class="app-label name"><span>*</span>  Nombre de Rol:</label>
                                        <div class="div-create-name">
                                            <input name="name" value="{{$name}}" class="app-form-control form-control  fadeInLeft animated" id="input-name" type="text" requiredd="">
                                        </div>
                                        @if ($errors->has('name'))
                                    ...
                                    <!-- begin col-2 -->
                                    <div class="app-form-group form-group col-md-6">
                                        <?php $slug=(!empty(old('slug')))?old('slug'):((!empty($role->slug))?$role->slug:'') ?>
                                        <label class="app-label slug"><span>*</span>  Slug:</label>
                                        <div class="div-create-slug">
                                            <input name="slug" value="{{$slug}}" class="app-form-control form-control  fadeInLeft animated" id="input-slug" type="text" requiredd="">
                                        </div>
                                        @if ($errors->has('slug'))
                                    ...
                                    <div class="app-form-group form-group col-md-12">
                                        <?php $description=(!empty(old('description')))?old('description'):((!empty($role->description))?$role->description:'') ?>
                                        <label class="app-label description"><span>*</span>  Descripción:</label>
                                        <div class="div-create-description">
                                            <input name="description" value="{{$description}}" class="app-form-control form-control  fadeInLeft animated" id="input-description" type="text" requiredd="">
                                        </div>
