            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="min-height:1000px">
                    <form action="{{url('seguimiento-modificar-registrar/'.$seguimiento->id)}}" method="post" accept-charset="utf-8"
                        ...
                        {{csrf_field()}}
                        <h2 class="col-md-8 col-md-offset-2" id="titulo">Ver datos del Seguimiento y Control</h2>
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2 form-group" style="">
                                <!--input type="submit" value="Guardar" name="guardar" class="btn btn-success"-->
                                <a href="{{url('seguimiento-form-buscar')}}" class="btn btn-success">Volver al listado</a>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div  class="col-12">
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="tratamiento" class="form-control " id="input-tratamiento" disabled>{{$tratamiento}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="descripcion_evolucion" class="form-control " id="input-descripcion_evolucion" disabled>{{$descripcion_evolucion}}</textarea>
                                ...
                                <div class="app-form-group form-group col-md-12 ">
                                    ...
                                    <textarea name="medicamento" class="form-control " id="input-medicamento" disabled>{{$medicamento}}</textarea>
