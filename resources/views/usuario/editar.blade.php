                                ...
                                <div  class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-nombre">
                                            <input name="nombre" value="{{$persona->nombre}}" class="app-form-control form-control  fadeInLeft animated" id="input-nombre" type="text" required>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-paterno">
                                            <input name="paterno" value="{{$persona->paterno}}" class="app-form-control form-control  fadeInLeft animated" id="input-paterno" type="text">
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-materno">
                                            <input name="materno" value="{{$persona->materno}}" class="app-form-control form-control  fadeInLeft animated" id="input-materno" type="text">
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="div-create-telefono">
                                            <input name="telefono" value="{{$persona->telefono}}" class="app-form-control form-control  fadeInLeft animated" id="input-telefono" type="number" required>    
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="div-create-celular">
                                            <input name="celular" value="{{$persona->celular}}" class="app-form-control form-control  fadeInLeft animated" id="input-celular" type="number" required>    
                                        </div>
                                     ...
                                     <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-direccion">
                                            <input name="direccion" value="{{$persona->direccion}}" class="app-form-control form-control  fadeInLeft animated" id="input-direccion" type="text" required>
                                        </div>
                                ...
                                <div  class="col-md-12">
                                    <div  class="col-md-8">
                                        ...
                                        <div class="form-group col-md-12" style="padding:0">
                                            ...
                                            <input name="ci" value="{{$persona->ci}}" class="app-form-control form-control  fadeInLeft animated" id="input-ci" type="text" required="">
                                            @if ($errors->has('ci'))
