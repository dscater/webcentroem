        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{{url('usuario-modificar-registrar/'.$user->id)}}" method="post" accept-charset="utf-8"
                        id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <h2 class="col-md-8 col-md-offset-2" id="titulo">
                           Ver datos de usuario</h2>
                        <div class="row">
                                ...
                                <div  class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-nombre">
                                            <input name="nombre" value="{{$persona->nombre}}" class="app-form-control form-control  fadeInLeft animated" id="input-nombre" type="text" disabled required>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-paterno">
                                            <input name="paterno" value="{{$persona->paterno}}" class="app-form-control form-control  fadeInLeft animated" id="input-paterno" type="text" disabled>
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-materno">
                                            <input name="materno" value="{{$persona->materno}}" class="app-form-control form-control  fadeInLeft animated" id="input-materno" type="text" disabled>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="div-create-telefono">
                                            <input name="telefono" value="{{$persona->telefono}}" class="app-form-control form-control  fadeInLeft animated" id="input-telefono" type="number" disabled required>    
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="div-create-celular">
                                            <input name="celular" value="{{$persona->celular}}" class="app-form-control form-control  fadeInLeft animated" id="input-celular" type="number" disabled required>    
                                        </div>
                                     ...
                                     <div class="form-group col-md-12">
                                        ...
                                        <div class="div-create-direccion">
                                            <input name="direccion" value="{{$persona->direccion}}" class="app-form-control form-control  fadeInLeft animated" id="input-direccion" type="text" disabled required>
                                        </div>
                                ...
                                <div  class="col-md-12">
                                    <div  class="col-md-8">
                                        ...
                                        <div class="form-group col-md-12" style="padding:0">
                                            ...
                                            <input name="ci" value="{{$persona->ci}}" class="app-form-control form-control  fadeInLeft animated" id="input-ci" type="text" disabled required>
                                            @if ($errors->has('ci'))
                                        ...
                                        <div class="form-group col-md-12" style="padding:0">
                                            ...
                                            <input name="email" value="{{$persona->email}}" class="app-form-control form-control  fadeInLeft animated" id="input-email" type="text" disabled required>
                                            @if ($errors->has('email'))
                                    ...
                                    <div  class="col-12">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="div-create-id_role">
                                                <select name="id_role" id="id_role" class="form-control " placeholder="Seleccionar" disabled required>
                                                    <option value="">Seleccionar</option>
                                                    @if(!empty($roles))
                                                    @foreach($roles as $key => $value)
                                                    <option value="{{$value->id}}" <?php echo ($value->id==$persona->id_role)?"selected":""?>>{{$value->name}}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div  class="col-12" style="display:none" id="div-especialidad">
                                        <div class="app-form-group form-group col-md-12">
                                            ...
                                            <div class="div-create-id_especialidad">
                                                <select name="id_especialidad" id="id_especialidad" class="form-control" placeholder="Seleccionar" requiredd disabled>
                                                    <option value="">Seleccionar</option>
                                                    @if(!empty($especialidad))
                                                    @foreach($especialidad as $key => $value)
                                                    <option value="{{$value->id}}" <?php echo ($value->id==$persona->id_especialidad)?"selected":""?>>{{$value->especialidad}}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
...
<script>
    $('document').ready(function () {
        ...
        $("#menu-usuario-form-buscar").addClass("active");
