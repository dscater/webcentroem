        ...
        <div class="panel panel-inverse">
            ...
            <div class="row">
                    <div class="col-md-9 text-center" style="">
                        <h2 style="margin-bottom:0">Administración de Usuarios</h2>
                ...
                <table id="data-table" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th id="th-ci">CI</th>
                            <th id="th-direccion">Dirección</th>
                            <th id="th-email">Email</th>
                            <th id="th-telefono">Teléfono</th>
                            <th id="th-celular">Celular</th>
                            <th id="th-foto">Foto</th>
                            <th id="th-genero">Fecha de Registro</th>
                            <th id="th-genero">Especialidad</th>
                    ...
                    <tbody id="tbody">
                        ...
                        <tr class="" id="tabla-tr-1">
                            ...
                            <td >{{$value->celular}}</td>
                            <td ><img src="{{url('fotoPersona/'.$value->foto)}}" width="80"/></td>
                            <td >{{date("d-m-Y", strtotime($value->created_at))}}</td>
                            <td >{{$value->especialidad}}</td>
                            <td class="td-acciones">
                                <a class="btn btn-xs btn-inverse" href="{{url('usuario-ver/'.$value->id)}}" target="blank"><span class="fa fa-eye"></span> Ver</a>
                                <a class="btn btn-xs btn-info" href="{{url('usuario-modificar/'.$value->id)}}" title="" target="blank"><span class="fa fa-pencil-square-o"></span> Editar</a>
...
<script>
    ...
    function eliminar() {
        ...
        window.location.href = "{{url('usuario-eliminar')}}/"+id;
    }
