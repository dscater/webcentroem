            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ url('reporte-paciente') }}" method="get" target="_blank" accept-charset="utf-8"
                            id="formulario-create">
                            <div class="row">
                                <div class="col-md-9 text-center" style="">
                                    <h2 style="margin-bottom:0">REPORTE LISTA DE PACIENTES</h2>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="app-form-group form-group col-md-12">
                                        ...
                                        @if (auth()->user()->hasRole('doctor'))
                                            <input type="hidden" name="id_especialidad"
                                                value="{{ auth()->user()->persona->id_especialidad }}">

                                            <input type="text" name="nom_especialidad" class="form-control"
                                                value="{{ auth()->user()->persona->especialidad }}" readonly>
                                        @else
                                    ...
                                    <div class="app-form-group form-group col-md-4">
                                        ...
                                        <div>
                                            <input name="desde" type="date" id="input-desde"
                                    ...
                                    <div class="app-form-group form-group col-md-4">
                                        ...
                                        <div>
                                            <input name="hasta" type="date" id="input-hasta"
                                                class="app-form-control form-control">
                                        </div>
                                    </div>
                                    <div class="app-form-group form-group col-md-12">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-print"></i> GENERAR
                                            REPORTE</button>
...
@section('script_3')
    <script>
        $('document').ready(function() {
            ...
            $("#menu-reporte-paciente").addClass("active");
        });
    </script>
@endsection
