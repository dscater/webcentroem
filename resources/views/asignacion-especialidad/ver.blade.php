        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="min-height:1000px">
                    <form action="{{url('asignacion-especialidad-modificar-registrar/'.$persona->id)}}" method="post" accept-charset="utf-8"
                        id="formulario-create" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <h2 class="col-md-8 col-md-offset-2" id="titulo">Ver datos de Asignación de Especialidad</h2>
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2 form-group" style="">
                                <!--input type="submit" value="Guardar" name="guardar" class="btn btn-success"-->
                                <a href="{{url('asignacion-especialidad-form-buscar')}}" class="btn btn-success">Volver al listado</a>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div  class="col-12">
                                <div class="app-form-group form-group col-md-12">
                                    ...
                                    <div class="div-create-id_especialidad">
                                        <?php $id_persona = (!empty(old('id_persona'))) ? old('id_persona') : $persona->id?>
                                        <select name="id_persona" id="id_persona" class="form-control chosen-select" data-rel="chosen" placeholder="Seleccionar" requiredd disabled>
                                            ...
                                            <option value="{{$value->id_persona}}" <?php echo ($value->id_persona==$id_persona)?"selected":""?>>Cód. Usuario: {{$value->name}} - {{$value->nombre}} {{$value->paterno}} {{$value->materno}} CI: {{$value->ci}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
